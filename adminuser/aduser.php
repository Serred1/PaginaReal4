<?php
 ...
 if(!isset($_SESSION["nombre"]) || !isset($_SESSION["apellido"]) || !isset($_SESSION["hora_conexion"])){
 header("Location: ../index.php");
 exit;
 }
 echo "Nombre: " . $_SESSION["nombre"] . "<br>";
 echo "Apellido: " . $_SESSION["apellido"] . "<br>";
 echo "Hora de Conexion: " . $_SESSION["hora_conexion"] . "<br>";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
if ($resultado->num_rows > 0) {
    ...
    while ($fila = $resultado->fetch_assoc()) {
        echo "<tr><td>" . $fila["nombre"] . "</td><td>" . $fila["apellido"] . "</td><td>" . $fila["ultima_conexion"] . "</td></tr>";
    }
    echo "</table>";
} else {
