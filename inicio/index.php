            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../encuestas/quiz1.php">Encuesta Video 1</a>
                        <a class="collapse-item" href="cards.html">Encuesta Video 2</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="foro.php">Foro</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <img class="primera" src="../img/fori.jpg" alt="perro">
                    <img class="segunda" src="../img/beef.jpg" alt="gato">

                    <!-- AQUI VA EL TITULO Y CONTENIDO -->
                    <h1>Texto de Prueba</h1>
    <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores sunt necessitatibus consequatur quos, hic, expedita veritatis reprehenderit quas ullam dolorem illo nisi! Deleniti dolorem natus tempora nemo commodi, omnis sint.
    </p>
                    <!-- Content Row -->
